...
function buscarUltimasMedidas2(idCachorro, limite_linhas) {
    ...
    if (process.env.AMBIENTE_PROCESSO == "producao") {
        ...
        instrucaoSql = `select count(idCachorro) from cachorro`;
    } else {
        console.log("\nO AMBIENTE (produção OU desenvolvimento) NÃO FOI DEFINIDO EM app.js\n");
        return
    }
...
function buscarMedidasEmTempoReal2(idCachorro) {
